...
- **Genotype × feeding system interaction**  
  ...
  [View example →](examples/dmu_example_1.md)
...
- **Direct and maternal genetic effects in sheep growth**  
  ...
  [View example →](examples/dmu_example_2.md)
...
- **Random regression model for growth hormone profiles**  
  ...
  [View example →](examples/dmu_example_rr.md)
...
## Case study: Genotype × feeding system interaction (DMU example I)
