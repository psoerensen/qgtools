...
qgtools separates **model structure**, **covariance specification**, and
**estimation**.
...
The same model structure can be estimated as a Bayesian model by replacing *vc()* with *prior()* and setting *task="bayes"*, without changing the formulas or kernels.
